<template>
 ...
 <v-card id="printJS-lunch" class="d-none">
    ...
    <div style="width: 100%; margin-bottom: -50px; ">
        <div>
            <p style="font-size: 40px; font-style: italic; position: relative; top: -0px;">{{ this.$store.state.quote }}</p>
            <p style="font-size: 40px; float: inline-end; position: relative; top: -40px; left: -40px">{{ this.$store.state.author }}</p>
        </div>
    </div>
 </v-card>
