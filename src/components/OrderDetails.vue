<template>
 ...
 <v-card id="printJS-lunch" class="d-none">
    ...
    <div style="width: 150%; padding-left: 150px;">
        ...
        <div style="position: relative; top: -190px;  padding-left: 260px;"><h1 style="font-size: 50px"> * 7% Tax Included $ {{ ($store.state.tables[$store.state.tableNum].totalPrice*0.07).toFixed(2) }}</h1></div>
    </div>
